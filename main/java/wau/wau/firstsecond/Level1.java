...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //пытаюсь выбрать массив начало
//        happy=random.nextInt(1);

        numLeft = random.nextInt(10);//генерируем  случайное  число
        img_left.setImageResource(array.gout1[numLeft]);//достаем из масива картинку
...
//        }
        ...
        img_right.setImageResource(array.gout1[numRight]);
        text_right.setText(array.texts3[numRight]);//достаем из масива текс
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (count==20){
                        ...
                        img_right.setImageResource(array.gout1[numRight]);//достаем из массива картику
