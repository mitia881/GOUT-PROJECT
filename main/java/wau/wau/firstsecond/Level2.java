...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.cherry_lady);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level2.this, MainActivity.class);//создали намерение для перехода
        ...
        img_left.setImageResource(array.gout2[numLeft]);//достаем из масива картинку
        text_left.setText(array.texts4[numLeft]);//достаем из массива текст

        numRight = random.nextInt(20-10)+10;//генерируем случайное число
        //цикл с предусловием, проверяющий равенство чисел начало
//        while (numLeft == numRight) {
//            numRight = random.nextInt(10);
//        }
        //цикл с предусловием, проверяющий равенство чисел конец
        img_right.setImageResource(array.gout2[numRight]);
        text_right.setText(array.texts4[numRight]);//достаем из масива текс
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(20-10)+10;//генерируем  случайное  число
                        img_left.setImageResource(array.gout2[numLeft]);//достаем из масива картинку
                        img_left.startAnimation(a);
                        text_left.setText(array.texts4[numLeft]);//достаем из массива текст

                        numRight = random.nextInt( 10) ;//генерируем случайное число
                        img_right.setImageResource(array.gout2[numRight]);//достаем из массива картику
